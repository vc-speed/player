window.addEventListener("DOMContentLoaded", () => {
  ...
  let playlist = [
    {name: "Faixa - 01 Kiko Chicabana", src: "web/FAIXA%2001.mp3"},
    {name: "Faixa - 02 Kiko Chicabana", src: "web/FAIXA%2002.mp3"},
    {name: "Faixa - 03 Kiko Chicabana", src: "https://github.com/vc-speed/player/raw/main/web/FAIXA%20(1).mp3"},
    {name: "Faixa - 04 Kiko Chicabana", src: "web/FAIXA%2004.mp3"},
    {name: "Faixa - 05 Kiko Chicabana", src: "web/FAIXA%2005.mp3"},
    {name: "Faixa - 06 Kiko Chicabana", src: "web/FAIXA%2006.mp3"},
    {name: "Faixa - 07 Kiko Chicabana", src: "web/FAIXA%2007.mp3"},
    {name: "Faixa - 08 Kiko Chicabana", src: "web/FAIXA%2008.mp3"},
    {name: "Faixa - 09 Kiko Chicabana", src: "web/FAIXA%2009.mp3"},
    {name: "Faixa - 10 Kiko Chicabana", src: "web/FAIXA%2010.mp3"},
    {name: "Faixa - 11 Kiko Chicabana", src: "web/FAIXA%2011.mp3"},
    {name: "Faixa - 12 Kiko Chicabana", src: "web/FAIXA%2012.mp3"},
    {name: "Faixa - 13 Kiko Chicabana", src: "web/FAIXA%2013.mp3"},
    {name: "Faixa - 14 Kiko Chicabana", src: "web/FAIXA%2014.mp3"},
    {name: "Faixa - 15 Kiko Chicabana", src: "web/FAIXA%2015.mp3"},
    {name: "Faixa - 16 Kiko Chicabana", src: "web/FAIXA%2016.mp3"},
    {name: "Faixa - 17 Kiko Chicabana", src: "web/FAIXA%2017.mp3"},
    {name: "Faixa - 18 Kiko Chicabana", src: "web/FAIXA%2018.mp3"},
    {name: "Faixa - 19 Kiko Chicabana", src: "web/FAIXA%2019.mp3"},
  ];
